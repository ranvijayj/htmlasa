			...
			if($command->execute())
			{
                ...
                if ($tableName != 'user_log') {
                    ...
                    if(is_array($primaryKey))
                    {
                        ...
                        $prKey = $this->$primaryKey;
                    }

                    UserLog::createLogRecord($userId, $tableName, $prKey, 2);
                }
	...
	public function update($attributes=null)
	{
		...
		if($this->beforeSave())
		{
            ...
            if ($tableName != 'user_log') {
                ...
                $prKey = is_array($this->getOldPrimaryKey()) ? implode(',', $this->getOldPrimaryKey()) : $this->getOldPrimaryKey();
                UserLog::createLogRecord($userId, $tableName, $prKey, 3);
            }
