...
class CEmailLogRoute extends CLogRoute
{
	...
	protected function processLogs($logs)
	{
        ...
        $this->setSentFrom(Yii::app()->config->get('EMAIL_FROM'));
		if($subject===null)
			$subject=Yii::t('yii','Application Error Log');
	...
	protected function sendEmail($email,$subject,$message)
	{
        ...
        */
        ...
        $replacedValues = array(
            ...
            '{{message_body}}' => '<p style="font-size: 12px;">' . nl2br(htmlspecialchars($message)) . '</p>',
