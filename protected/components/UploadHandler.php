...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'post_max_size' => 'Some of selected files exceeds the 4MB (Post size)  allowed by system and was not uploaded',
        'max_file_size' => 'Some of selected files exceeds the 4MB allowed by system and was not uploaded',
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/protected/data/current_uploads_files/'.Yii::app()->user->userID.'/'.date('Y-m-d')."/",
            //'upload_dir' => 'protected/data/current_uploads_files',
            'upload_url' => $this->get_full_url().'/protected/data/current_uploads_files/',
            'user_dirs' => false,
            'mkdir_mode' => 0775,
            'param_name' => 'files',
            ...
            //'accept_file_types' => '/.+$/i',
            'accept_file_types' => '/\.(gif|png|jpg|jpeg|bmp|gif|png|tiff|tif|pdf)$/i',
