...
class Paypal extends CComponent {
    ...
    */
    ...
    public function init(){
        ...
        $this->apiUsername = Yii::app()->config->get('PAYPAL_API_USERNAME');
        $this->apiPassword = Yii::app()->config->get('PAYPAL_API_PASSWORD');
        $this->apiSignature = Yii::app()->config->get('PAYPAL_API_SIGNATURE');
    }
