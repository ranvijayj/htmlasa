<div class="modal_box" id="credit_card_info" style="display:none;">
    ...
    <form action="<?php echo Yii::app()->createUrl('stripe/executerppayment'); ?>" method="post" id="cc_info_form">
        ...
        <input type="hidden" id="copies_count" name="copies_count" value="">
        <input type="hidden" id="pages_on_sheet" name="pages_on_sheet" value="">
