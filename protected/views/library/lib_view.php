<div id="document_info_block" data-id="<?=$document->Document_ID?>"></div>
<div class="document_block width100p" id="document_block<?php echo $tabNum; ?>" data-mime-type="<?php echo $document->image->Mime_Type; ?>" data-id="<?php echo $document->Document_ID; ?>" data-subsid="<?php echo $subsectionID; ?>">
