...
<div class="account_manage">
    ...
    <?php } ?>
    <span class="de_count_items" style="margin-left: <?php echo ($num_pages > 0) ? '65' : '10'; ?>px;">Assign to Process: <?php echo $num_pages; ?> items</span>
</div>
