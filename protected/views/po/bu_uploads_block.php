<!-- This view used for BU uploading from tab2 of pages po/detail   -->
    ...
    <div class="right uploads_block_right">
        ...
        <table>
            <tr><td class="dropdown_cell_upload"><span class="dropdown_cell_value">BU</span></div> </td></tr>
        </table>
        <?php
            if (!$detailsPage) {
                ?>
