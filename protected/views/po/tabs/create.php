<div class="po_create_div">
    ...
    if ($poId == 0) {
        ?>
        <p class="po_create_status">Creating new PO</p>
    <?php
    } else {
        ?>
        ...
        <div class="right po_creating_right" id="total_fields">
            <fieldset>
                <div class="group">
                    ...
                    <?php echo $form->textField($po,'PO_Subtotal', array('disabled'=>"disabled")); ?>
                    <?php echo $form->error($po,'PO_Subtotal'); ?>
                </div>
                <div class="group">
                    <?php echo $form->label($po,'PO_Tax'); ?>
                    <?php echo $form->textField($po,'PO_Tax', array('class'=>"dollar_fields")); ?>
                    <?php echo $form->error($po,'PO_Tax'); ?>
                </div>
                <div class="group">
                    <?php echo $form->label($po,'PO_Delivery_Chg'); ?>
                    <?php echo $form->textField($po,'PO_Delivery_Chg', array('class'=>"dollar_fields")); ?>
                    <?php echo $form->error($po,'PO_Delivery_Chg'); ?>
                </div>
                <div class="group">
                    <?php echo $form->label($po,'PO_Other_Chg'); ?>
                    <?php echo $form->textField($po,'PO_Other_Chg', array('class'=>"dollar_fields")); ?>
                    <?php echo $form->error($po,'PO_Other_Chg'); ?>
                </div>
                <div class="group">
                    <?php echo $form->label($po,'PO_Total'); ?>
                    <?php echo $form->textField($po,'PO_Total', array('disabled'=>"disabled")); ?>
