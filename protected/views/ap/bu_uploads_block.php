<!-- This view used for BU uploading from tab2 of pages ap/detail   -->
    ...
    <div class="left uploads_block_left">
        <p>AP Detail: Upload <?php echo (!$detailsPage) ? '& Entry:' : 'BU'; ?></p>
                ...
                <div id="additional_fields_block_file"
                    ...
                    if (strpos($file['mimetype'], 'pdf')) {
                        if (Helper::getMobileDetect()->isMobile() || Helper::getMobileDetect()->isTablet() || Helper::checkMobile()) {
                            echo '<iframe src="http://docs.google.com/viewer?url=' . Helper::generateAPBUGoogleDocsUrl() . '&embedded=true" class="documet_file height100pn width100pn"></iframe> ';
                        } else {
                            echo '<embed src="/ap/getdocumentfile" id="document_file" type="' . $file['mimetype'] . '" class="documet_file height100pn width100pn">';
                        }
                    } else {
                        echo '<img src="/ap/getdocumentfile" alt="" id="document_file" title="" class="documet_file width100pn">';
                    }
                    ?>
                </div>
    ...
    <div class="right uploads_block_right">
        ...
        <table>
            <tr><td class="dropdown_cell_upload"><span class="dropdown_cell_value">BU</span></td></tr>
        </table>
        <?php
            if (!$detailsPage) {
                ?>
